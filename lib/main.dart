...
import 'ui/pages/news_management_simple.dart';
import 'ui/pages/forum_management_simple.dart';
import 'ui/pages/health_management_simple.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/news': (context) => const NewsManagementPage(),
        '/forum': (context) => const ForumManagementPage(),
        '/health': (context) => const HealthManagementPage(),
      },
    );
  }
}
